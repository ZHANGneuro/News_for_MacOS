...
- (id)initWithFrame:(NSRect)frameRect{
    ...
    if (self) {
        ...
        [public_info setTrackTintColor:[[NSColor orangeColor] colorWithAlphaComponent:0.0f]];
        [public_info setProgressTintColor:[NSColor colorWithRed:(244/255.0) green:(91/255.0) blue:(105/255.0) alpha:1]];
        [public_info setInnerTintColor:nil];
        [public_info setThicknessRatio:0.25f];
...
- (void)initializeLabel{
    ...
    [_progressLabel setFont:[NSFont fontWithName:@"Arial" size:20]];
    [_progressLabel setAlignment:NSTextAlignmentCenter];
    [_progressLabel setBackgroundColor:[NSColor clearColor]];
    [_progressLabel setTextColor:[NSColor blackColor]];
